        ...
        <div className="max-w-6xl mx-auto px-10 space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-5">
              <p className="text-[11px] text-stone-300 tracking-[0.15em] uppercase mb-4">01 — Eleven</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-5 order-1 md:order-2">
              <p className="text-[11px] text-stone-300 tracking-[0.15em] uppercase mb-4">02 — Läraren</p>
              <h3 className="text-2xl md:text-3xl font-medium text-stone-800 tracking-[0.02em] leading-[1.2] mb-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-5">
              <p className="text-[11px] text-stone-300 tracking-[0.15em] uppercase mb-4">03 — Skolan</p>
              <h3 className="text-2xl md:text-3xl font-medium text-stone-800 tracking-[0.02em] leading-[1.2] mb-5">
